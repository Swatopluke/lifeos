...
| | |
|---|---|
| **generated** | 2026-08-17T22:34:56Z |
| **commit** | `5d0dbc3a14b980800c354731d10fc926cdfa6ec5` |
| **nodes** | 77 |
| **edges** | 191 |
| **layers** | 6 |
| **tour steps** | 5 |
...
|---|---|---|
| `css/styles.css` | 0 | Design tokens and layout, 520 lines. |
...
| `js/dashboard.js` | 7 | Per-section loaders over a shared 28-day cache. 7 export(s), 565 lines. |
...
| `js/timeline.js` | 5 | Module timeline.js. 5 export(s), 151 lines. |
